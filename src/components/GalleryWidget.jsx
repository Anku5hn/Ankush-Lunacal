      ...
      <div className="w-[calc(50vw-4rem)] h-[calc(50vh-3rem)] flex flex-nowrap rounded-[19px] bg-custom-dark-gray shadow-2xl">
        ...
        <div className="mt-[1rem] w-full mx-[1rem] ">
          <div className="rounded-[23px] w-[36vw] h-[62px] flex justify-between items-center">
            ...
            <div>
              <button className="text-white text-[18px] rounded-l-full rounded-r-full mx-5 gallery-addBtn-inner">
                <p className="px-4 py-4 rounded-r-full rounded-l-full gallery-addBtn-drop text-[12px] font-semibold">+ Add Image</p>
              </button>
              <button className="w-[45px] h-[45px] bg-custom-black-two rounded-full mx-5 hover:bg-custom-black-one gallery-addBtn-dropTwo" onClick={()=>{handleGalleryScroll(-50)}}>
                <ArrowLeftOutlined className="text-custom-light-gray text-[24px] shadow-md" />
              </button>
              <button className="w-[45px] h-[45px] bg-custom-black-two rounded-full hover:bg-custom-black-one gallery-addBtn-dropTwo" onClick={()=>{handleGalleryScroll(50)}}>
